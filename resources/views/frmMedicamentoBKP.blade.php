    ...
    <div class="row">
      <div class="col-md-4">
        @if ($medicamento->imagem != "")
          <img class="card-img-top medicamento-imagem" src="/storage/imagens/{{$medicamento->imagem}}" alt="Imagem do Medicamento">
        @endif
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <div class="shadow p-4">
          ...
          <div class="mb-3">
            ...
            <select class="form-select @error('transportadora_id') is-invalid @enderror" name="transportadora_id">
              @foreach($transportadoras as $transportadora)
                <option {{ $transportadora->id == old('transportadora_id', $medicamento->transportadora_id) ?'selected': ''}} value="{{$transportadora->id}} ">{{$transportadora->nome}}</option>
              @endforeach
            </select>
        ...
        <button class="btn btn-primary btn-block mt-3 animated infinite pulse btn-glow" type="submit" name="button">Salvar</button>
